  ...
  return (
    <DataTablePage
      ...
      columns={[
        ...
        { key: "MaDG", label: "Mã độc giả", tableHidden: true, formHidden: true, excelHidden: true },
        ...
        { key: "MaSach", label: "Mã sách", tableHidden: true, formHidden: true, required: false, excelHidden: true },
        { key: "TenSach", label: "Tên sách", tableHidden: true, formHidden: true, required: false, excelHidden: true },
        { key: "LoaiViPham", label: "Loại vi phạm", tableHidden: true, formHidden: true, excelHidden: true, displayValue: (row) => TYPE_LABELS[row.LoaiViPham] ?? row.LoaiViPham },
        ...
        { key: "MaNVThu", label: "NV thu", formHidden: true, tableHidden: true, required: false, excelHidden: true },
