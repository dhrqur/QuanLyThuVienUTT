...
export default function App() {
  return <CartProvider><Routes>
    ...
    <Route element={<ProtectedRoute allowPasswordChange />}><Route path="/doi-mat-khau" element={<ChangePasswordPage />} /></Route>
  ...
  </Routes><Toaster closeButton position="top-right" richColors /></CartProvider>;
}
